    ...
    public boolean Lista_enviar_mod_disco_mus(String nombre_disco, int precio) {
        ...
        if (lista != null) {
            ...
            for (int i = 0; i < lista_correos.size(); i++) {
                ...
                CRUB_Archivos ca = new CRUB_Archivos();
                ca.eliminar_preorden(nombre_disco, "src/Archivos/Pre_Ordenes_Musica.txt");
            }
    ...
    public boolean Lista_enviar_mod_disco_pel(String nombre_disco, int precio) {
        ...
        if (lista != null) {
            ...
            for (int i = 0; i < lista_correos.size(); i++) {
                ...
                CRUB_Archivos ca = new CRUB_Archivos();
                ca.eliminar_preorden(nombre_disco, "src/Archivos/Pre_Ordenes_Peliculas.txt");
            }
