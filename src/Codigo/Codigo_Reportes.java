...
public class Codigo_Reportes {
    ...
    public ArrayList<Dato_Compras> rep3(String fecha_1, String fecha_2, String archivo) {
        ...
        if (fecha_minima.isBefore(fecha_maxima)||fecha_minima.equals(fecha_maxima)) {
            ...
            JOptionPane.showMessageDialog(null, "Ingrese primero la fecha menor primero y despues la mayor");
        }
